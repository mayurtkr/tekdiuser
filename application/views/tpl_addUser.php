    ...
    jQ( "#successMsg" ).dialog({
     ...
     $('#submit_btn').click(function(){ 
            ...
            if(validates()){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "<?PHP echo base_url();?>user/addUserAjax",
                        data: var_form_data,
                        dataType: 'html',
                        success: function (data){
                        if(parseInt(data)==1)
                        {
                            /*var data ="User record added successfully."
                            $("#successMsg").html("<div class='alert alert-success'>"+data+"</div>");
...
<table width="100%" border="0">
  ...
  <tr class="rowClass">
    ...
    <td>&nbsp;</td>
    <td align="left">
        <?PHP echo form_input('user_name', set_value('user_name', ''),'class="input-field" id="user_name"');?>
  ...
  <tr class="rowClass">
   <td align="left" valign="top" >Country:<span class="required">*</span></td>
    <td>&nbsp;</td>
    <td align="left">
        <?PHP echo form_input('user_country', set_value('user_country', ''),'class="input-field" id="user_country"');?>
  ...
  <tr class="rowClass">
   <td align="left" valign="top" >Email:<span class="required">*</span></td>
    <td>&nbsp;</td>
    <td align="left">
        <?PHP echo form_input('user_email', set_value('user_email', ''),'class="input-field" id="user_email"');?>
  ...
  <tr class="rowClass">
   <td align="left" valign="top" >Mobile Number:<span class="required">*</span></td>
    <td>&nbsp;</td>
    <td align="left">
        <?PHP echo form_input('user_mobile', set_value('user_mobile', ''),'class="input-field" id="user_mobile"');?>
  ...
  <tr class="rowClass">
   <td align="left" valign="top" >About You:<span class="required">*</span></td>
    <td>&nbsp;</td>
    <td align="left">
        <?PHP echo form_input('user_about', set_value('user_about', ''),'class="input-field" id="user_about"');?>
  ...
  <tr class="rowClass">
   <td align="left" valign="top" >Birthday:<span class="required">*</span></td>
    <td>&nbsp;</td>
    <td align="left">
        <?PHP echo form_input('user_bday', set_value('user_bday', ''),'class="input-field" id="user_bday" ');?>
...
<div id="successMsg" title="Message" style="display:none;">
  <p>User record added successfully.</p>
</div>
